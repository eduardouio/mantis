...
class VehicleCreateView(CreateView):
    ...
    fields = [
        ...
        'engine_number', 'chassis_number', 'notes'
    ]
    success_url = reverse_lazy('equipment:vehicle_list')
    
    def form_valid(self, form):
        messages.success(self.request, f'Vehículo {form.instance.no_plate} creado exitosamente.')
        return super().form_valid(form)
    
    def form_invalid(self, form):
        messages.error(self.request, 'Error al crear el vehículo. Verifique los datos ingresados.')

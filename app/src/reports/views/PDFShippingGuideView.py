...
class PDFShippingGuideView(View):
    ...
    def get(self, request, *args, **kwargs):
        """Genera un PDF de la guía de remisión y lo devuelve como respuesta."""
        shipping_guide_id = kwargs.get('id')
        
        template_path = reverse("shipping-guide-report", kwargs={'id': shipping_guide_id})
        ...
        filename = f"GuiaRemision-{shipping_guide_id}-{datetime.now().strftime('%Y%m%d')}.pdf"

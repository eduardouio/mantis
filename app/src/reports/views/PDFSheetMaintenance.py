...
class PDFSheetMaintenance(View):
	...
	def get(self, request, *args, **kwargs):
		"""Genera un PDF de la hoja de mantenimiento y lo devuelve como respuesta."""
		...
		filename = f"HojaMantenimiento-{sheet_id}-{datetime.now().strftime('%Y%m%d')}.pdf"

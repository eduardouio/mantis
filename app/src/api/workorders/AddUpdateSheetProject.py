...
class AddUpdateSheetProjectAPI(View):
    ...
    def get(self, request):
        ...
        try:
            ...
            sheet = SheetProject.objects.filter(
                id=sheet_id,
                is_active=True
            ).select_related('project', 'project__partner').first()
    ...
    def _create_sheet(self, request, data):
        ...
        # Verificar que no haya hoja en progreso para el mismo proyecto
    ...
    def _update_sheet(self, request, data):
        ...
        # No permitir edición si está facturada
        ...
        if 'details' in data:
            # Marcar detalles actuales como inactivos
    ...
    def _add_detail(self, sheet, detail_data, user):
        ...
        try:
            resource = ResourceItem.objects.get(
                id=resource_id,
                is_active=True
            )

...
class UpdateResourceAPI(View):
    ...
    def post(self, request):
        ...
        if not resource_id:
            return JsonResponse(
                {"success": False, "error": "El campo id es requerido"}, status=400
            )
                    ...
                    if isinstance(value, str):
                        ...
                        for fmt in (
                            ...
                            try:
                                ...
                                continue
                        if not parsed:
                            errors[field_name] = "Formato de fecha/hora inválido"
                            continue
                        value = parsed
            ...
            if checklist_touched and not status_explicitly_set:
                try:
                    ...
                    if values:
                        ...
                        if (
                            all_checked
                            and resource.stst_status_equipment == "INCOMPLETO"
                        ):
    ...
    def _serialize(self, resource: ResourceItem):
        ...
        base = {
            ...
            "stst_status_equipment": getattr(resource, "stst_status_equipment", None),
        }

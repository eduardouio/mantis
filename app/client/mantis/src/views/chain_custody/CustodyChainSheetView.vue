...
<template>
  <div class="w-[95%] mx-auto p-4">
    ...
    <div class="bg-white rounded-2xl shadow-md border border-purple-300 border-t-[15px] border-t-purple-300 p-6 mb-6">
      <div class="flex justify-between items-center border-b-purple-500 border-b pb-3 mb-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="bg-cyan-50 rounded-lg p-4 border border-cyan-200">
          <h3 class="font-semibold text-cyan-700 mb-3 flex items-center gap-2">
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6">
      <h2 class="font-semibold text-lg mb-4 flex items-center gap-2">
        <i class="las la-list text-purple-600"></i>
        ...
        <table class="table table-zebra w-full">
          <thead>
            <tr class="bg-purple-600 text-white">
              <th class="p-2 border border-purple-400 text-center">#</th>
              <th class="p-2 border border-purple-400 text-center">Serie</th>
              <th class="p-2 border border-purple-400 text-center">Fecha Emisión</th>
              <th class="p-2 border border-purple-400 text-center">Hora Inicio</th>
              <th class="p-2 border border-purple-400 text-center">Hora Fin</th>
              <th class="p-2 border border-purple-400 text-center">Horas</th>
              <th class="p-2 border border-purple-400 text-center">Contacto</th>
              <th class="p-2 border border-purple-400 text-center">Conductor</th>
              <th class="p-2 border border-purple-400 text-center">Galones</th>
              <th class="p-2 border border-purple-400 text-center">Barriles</th>
              <th class="p-2 border border-purple-400 text-center">M³</th>
              <th class="p-2 border border-purple-400 text-center">Acciones</th>
            </tr>
          </thead>
          <tbody>
    ...
    <div class="stats shadow w-full mt-6">
      <div class="stat">
        ...
        <div class="stat-value text-purple-600">{{ custodyChains.length }}</div>
        <div class="stat-desc">Registradas</div>
      </div>
      
      <div class="stat">
        <div class="stat-title">Horas Totales</div>
        <div class="stat-value text-blue-600">{{ totalHours }}</div>
        <div class="stat-desc">Horas trabajadas</div>
      </div>

      <div class="stat">
        <div class="stat-title">Total Galones</div>
        <div class="stat-value text-cyan-600">{{ totalGallons.toLocaleString() }}</div>
        <div class="stat-desc">Acumulados</div>
      </div>

      <div class="stat">
        <div class="stat-title">Total Barriles</div>
        <div class="stat-value text-teal-600">{{ totalBarrels }}</div>
        <div class="stat-desc">Acumulados</div>
      </div>

      <div class="stat">
        <div class="stat-title">Total M³</div>
        <div class="stat-value text-green-600">{{ totalCubicMeters }}</div>
        <div class="stat-desc">Acumulados</div>
      </div>
    </div>
  </div>
